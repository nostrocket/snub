...
Repo anchor event
* pointers to all canonical origins
* maintainer list or rocket ID

Nostr git origin
* bare git repo
* objects are pushed using keypair
* publicly accessible
* allowed keypairs come from repo anchor event (maintainer list)
* repo is identified by anchor event ID
* automatically tries to push all updates to other peers listed as canonical origins in anchor event

git pull verifies signatures
